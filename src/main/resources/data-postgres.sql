...
INSERT INTO public.klinika(
	...
	VALUES (nextval('klinika_id_seq'), 'Jovana Obrenovica 83A', '+381/68-899675', 'Crna Gora', 'Pljevlja', 'Sveti vid', 3.5, 'Vrlo lepo');


INSERT INTO public.admin_klinike(
	id, adresa, broj_telefona, drzava, grad, ime, lozinka, mail, prezime,klinika_id)
	VALUES (nextval('admin_klinike_id_seq'),'Janka Veselinovica 17', '+381/68-123321', 'Srbija', 'Novi Sad', 'Damjan', 'damjanbanjac', 'damjanbanjac14@gmail.com', 'Banjac',1);
